...
const {getCompanies , getCompany , createCompany , updateCompany , deleteCompany , getTimeSlot} = require('../controller/companies');
...
router.route('/:id/timeslot').get(getTimeSlot)
